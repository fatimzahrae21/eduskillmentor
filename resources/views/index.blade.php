    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="{{asset('imgfile/about-img.svg')}}" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
        ...
        <div class="row gy-4 mt-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link">Experienced Instructors</a></h4>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link">Comprehensive Courses</a></h4>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link">Innovative Learning</a></h4>
            </div>
          </div><!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link">Certification Programs</a></h4>
            </div>
          </div><!--End Icon Box -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Us</h2>
          <p>Welcome to eduSkillmentor, your premier destination for online education and professional development. Our mission is to empower individuals worldwide by providing high-quality, accessible learning opportunities that enable personal and professional growth.</p>
        </div>
    
        <div class="row gy-4">
          <div class="col-lg-6">
            <h3>Our Commitment to Excellence</h3>
            <img src="{{asset('imgfile/aboutimg.jpg')}}" class="img-fluid rounded-4 mb-4" alt="About Us Image">
            <p>At eduSkillmentor, we believe that education is the key to unlocking potential. That's why we partner with leading experts and institutions to deliver comprehensive courses and training programs across a wide range of subjects.</p>
            <p>Whether you're looking to enhance your skills, explore new career paths, or pursue lifelong learning, we're here to support you every step of the way. Join our community today and embark on your journey towards success!</p>
          </div>
          <div class="col-lg-6">
            <div class="content ps-0 ps-lg-5">
              ...
              <ul>
                <li><i class="bi bi-check-circle-fill"></i> High-quality, expert-led courses</li>
                <li><i class="bi bi-check-circle-fill"></i> Flexible learning options for busy schedules</li>
                <li><i class="bi bi-check-circle-fill"></i> Accessible platform for learners of all backgrounds</li>
              </ul>
              <p>
                At eduSkillmentor, we're dedicated to providing an exceptional learning experience that empowers individuals to reach their full potential. Join us in shaping the future of education!
              </p>
              <div class="position-relative mt-4">
                <img src="{{asset('imgfile/aboutimg2.png')}}" class="img-fluid rounded-4" alt="">
    ...
    <section id="stats-counter" class="stats-counter">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6">
            <img src="{{asset('imgfile/stats-img.svg')}}" alt="" class="img-fluid">
          </div>

          <div class="col-lg-6">
            <div class="stats-item d-flex align-items-center">
              <span data-purecounter-start="0" data-purecounter-end="1000" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Students Enrolled</strong> - The total number of students currently enrolled in courses.</p>
            </div><!-- End Stats Item -->
          
            <div class="stats-item d-flex align-items-center">
              <span data-purecounter-start="0" data-purecounter-end="50" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Courses Offered</strong> - The total number of courses available on the platform.</p>
            </div><!-- End Stats Item -->
          
            <div class="stats-item d-flex align-items-center">
              <span data-purecounter-start="0" data-purecounter-end="500" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Hours Of Instruction</strong> - The total number of hours of instructional content available.</p>
            </div><!-- End Stats Item -->
          </div>
    ...
    <section id="services" class="services sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Our Formation Services</h2>
          <p>Explore our range of formation services tailored to meet your learning needs.</p>
        </div>
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Our Team</h2>
          <p>Meet the talented individuals behind our formation platform.</p>
        </div>
