...
<form action="{{route('courses.update',$course->id)}}" method="GET" enctype="multipart/form-data">
    @csrf
@method('PUT')
    <div class="mb-3">
...
@enderror
    ...
    <div class="mb-3">
        ...
        <textarea type="text" name="description" class="form-control" >{{old('description',$course->description)}}</textarea>
    </div>
    <div class="mb-3">
