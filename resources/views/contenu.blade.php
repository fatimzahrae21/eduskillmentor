...
<body>
  ...
  <main id="main">
              ...
              <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                 ...
                 <div class="swiper-slide">
                    <img src="{{asset('imgfile/about-img.svg')}}" alt="">
                  </div>
    ...
    <h2 class="blog-details">Course introduction</h2>
    <p class="blog-details"> {{ $content->course->title}} </p>
                <article class="blog-details">

    
                  <div class="post-img">
                    <img src="{{asset('imgfile/about-img.svg')}}" alt="" class="img-fluid">
                  </div>
                  ...
                  <div class="content">
                    ...
                    <img src="{{asset('imgfile/about-img.svg')}}" class="img-fluid" alt="">
                ...
                <div class="comments">
                  ...
                  <div id="comment-1" class="comment">
                    <div class="d-flex">
                      <div class="comment-img"><img src="{{asset('imgfile/team1.jpg')}}" alt=""></div>
                      <div>
                  ...
                  <div class="sidebar-item recent-posts">
                    ...
                    <div class="mt-3">
                      ...
                      <div class="post-item mt-3">
                        <img src="{{asset('imgfile/blog-recent-1.jpg')}}" alt="">
                        <div>
                      ...
                      <div class="post-item">
                        <img src="{{asset('imgfile/blog-recent-2.jpg')}}" alt="">
                        <div>
                      ...
                      <div class="post-item">
                        <img src="{{asset('imgfile/blog-recent-3.jpg')}}" alt="">
                        <div>
                      ...
                      <div class="post-item">
                        <img src="{{asset('imgfile/blog-recent-4.jpg')}}" alt="">
                        <div>
                      ...
                      <div class="post-item">
                        <img src="{{asset('imgfile/blog-recent-5.jpg')}}" alt="">
                        <div>
