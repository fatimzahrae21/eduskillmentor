...
@enderror
            ...
            <p>
                Don't have an account yet ? <a href="{{route('signIn')}}">Sing In</a>
            </p>
        </form>
    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-center">Already have an account? <a href="{{ route('signin') }}" class="text-primary">Login here</a></p>
                            </div>
                        </div>
                    </div>
                </div>
